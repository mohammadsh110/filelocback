...
const DropImage = (props) => {
    ...
    const getUploadParams = ({ meta }) => {
        const url = 'https://filesharelocation.herokuapp.com:1900/uploadImage/'
    ...
    const sendLocation = () => {
        ...
        fetch(
            'https://filesharelocation.herokuapp.com:1900/location/',
            {
                method: 'POST',
                body: formData,
            }
    ...
    const handleSubmit = (files, allFiles) => {
        fetch(
            'https://filesharelocation.herokuapp.com:1900/uploadImage/',
            {
                method: 'POST',
